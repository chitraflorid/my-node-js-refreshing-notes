...
The "After-Every-Task" Rule: > Microtasks (nextTick and Promises) are interrupts. They don't wait for a phase to end; they drain after every single callback.

The Poll Phase "Sleep": > The Event Loop stays efficient by "parking" in the Poll phase to wait for I/O, unless there are setImmediate or expired timers waiting.
